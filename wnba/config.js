/* JTT WNBA sport module — config for the unified shell (AFL/index.html?sport=nbl).
   Basketball mapped onto the shell's sport-config contract, modelled on mlb/config.js.
   Data comes from wnba/data/* (built by build_nbl.py from nblR). */
window.SPORT_CONFIG = {
  key: "wnba",
  dir: "wnba",
  name: "WNBA",
  logoExt: ".png",
  minutesFloor: 12,
  logoCdn: "https://a.espncdn.com/i/teamlogos/wnba/500/",                 // logos are per-team absolute URLs carried on teams.json (t.logo)
  logoCdnExt: ".png",
