...
window.SPORT_CONFIG = {
  ...
  mktNames: { passYds:'Pass Yds', passAtt:'Pass Att', passTds:'Pass TDs', rushYds:'Rush Yds', rushAtt:'Rush Att', receptions:'Receptions', recYds:'Rec Yds', rushRecYds:'Rush+Rec Yds', anytimeTd:'Anytime TD', tackles:'Tackles+Ast', sacks:'Sacks', passInt:'Pass INTs', kickingPts:'Kicking Pts', fgMade:'FG Made' },
