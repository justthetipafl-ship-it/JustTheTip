...
window.SPORT_CONFIG = {
  ...
  mktNames: { passYds:'Pass Yds', passAtt:'Pass Att', passTds:'Pass TDs', rushYds:'Rush Yds', rushAtt:'Rush Att', receptions:'Receptions', recYds:'Rec Yds', rushRecYds:'Rush+Rec Yds', anytimeTd:'Anytime TD', tackles:'Tackles+Ast', sacks:'Sacks', passInt:'Pass INTs', longRec:'Longest Rec', longRush:'Longest Rush', longComp:'Longest Comp', firstScorer:'First TD', kickingPts:'Kicking Pts', fgMade:'FG Made' },
  ...
  multiMkts: [['passYds','Pass Yds'],['rushYds','Rush Yds'],['recYds','Rec Yds'],['receptions','Receptions'],['rushAtt','Rush Att'],['passAtt','Pass Att'],['rushRecYds','Rush+Rec'],['anytimeTd','Anytime TD'],['tackles','Tackles+Ast'],['sacks','Sacks'],['passInt','Pass INTs'],['kickingPts','Kicking Pts'],['fgMade','FG Made']],
  ...
  crew: [{k:'multi',n:'Multi Builder',i:'ti-stack-2',d:'Stacked legs'},
    ...
    {k:'sacks',n:'Sack Artists',i:'ti-bolt-off',d:'Rushers v leaky O-lines'},
    {k:'picks',n:'Pick Watch',i:'ti-hand-stop',d:'INT risk into ball-hawk Ds'},
