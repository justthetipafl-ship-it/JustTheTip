...
window.SPORT_CONFIG = {
  ...
  mktNames: { passYds:'Pass Yds', passAtt:'Pass Att', passTds:'Pass TDs', rushYds:'Rush Yds', rushAtt:'Rush Att', receptions:'Receptions', recYds:'Rec Yds', rushRecYds:'Rush+Rec Yds', anytimeTd:'Anytime TD', tackles:'Tackles+Ast', sacks:'Sacks', kickingPts:'Kicking Pts', fgMade:'FG Made' },
  ...
  multiMkts: [['passYds','Pass Yds'],['rushYds','Rush Yds'],['recYds','Rec Yds'],['receptions','Receptions'],['rushAtt','Rush Att'],['passAtt','Pass Att'],['rushRecYds','Rush+Rec'],['anytimeTd','Anytime TD'],['tackles','Tackles+Ast'],['sacks','Sacks'],['kickingPts','Kicking Pts'],['fgMade','FG Made']],
