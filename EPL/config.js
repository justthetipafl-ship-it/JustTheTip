...
window.SPORT_CONFIG = {
  ...
  tileOrder: ['locked-in','on-a-run','first-goal','tap-ins','penalty-kings','spam-square',
              'goals-galore','corner-storm','mismatch','brick-wall','tackle-machines','fouled-again','form-alerts','falling-off'],
};
