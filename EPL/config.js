...
*/
window.SPORT_CONFIG = {
  liveWorker: 'https://jtt-live.justthetipafl.workers.dev/epl',   // live player stats for the tracker
  ...
  crew: [
    ...
    { k:'green-lights',   n:'Green Lights',  i:'ti-traffic-lights',        d:'Strong overs the model + form back' },
    { k:'bunnies',        n:'Bunnies',       i:'ti-carrot',                d:'Feasts on this opponent historically' },
    { k:'streakers',      n:'Streakers',     i:'ti-flame',                 d:'Cleared their line in N straight' },
    ...
    { k:'form-alerts',    n:'Form Alerts',   i:'ti-temperature-celsius',   d:'Form spiking or cooling, both ways' },
  ],
  tileOrder: ['green-lights','locked-in','streakers','bunnies','first-goal','tap-ins','penalty-kings','spam-square',
              'goals-galore','corner-storm','mismatch','brick-wall','tackle-machines','fouled-again','form-alerts'],
};
