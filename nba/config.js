/* JTT NBA sport module — config for the unified shell (AFL/index.html?sport=nbl).
   Basketball mapped onto the shell's sport-config contract, modelled on mlb/config.js.
   Data comes from nba/data/* (built by build_nbl.py from nblR). */
window.SPORT_CONFIG = {
  key: "nba",
  dir: "nba",
  name: "NBA",
  logoExt: ".png",
  minutesFloor: 15,
  logoCdn: "https://a.espncdn.com/i/teamlogos/nba/500/",                 // logos are per-team absolute URLs carried on teams.json (t.logo)
  logoCdnExt: ".png",
